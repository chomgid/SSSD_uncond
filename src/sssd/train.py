...
def train(output_directory,
    ...
    with open('/home/chomgid14/TSdata/PTB_train_1000.pkl', 'rb') as tf:
        data_ptbxl = np.array(pickle.load(tf))
    ...
    trainloader = torch.utils.data.DataLoader(data_ptbxl, shuffle=True, batch_size=6, drop_last=True)
